...
미술치료에서의 미술은 작품의 완성도보다는 과정에서 나타나는 표현에 중심을 둠으로써 내담자 스스로 자신의 내면을 읽어낼 수 있고, 구체적인 결과물이 자료로 남게 됨에 따라 치료의 과정 자체를 객관적으로 관찰할 수 있다는 장점이 있습니다.`,
  ...
  },
  {
    ...
    detail: {
      description: `시각, 청각적으로 받아들인 정보를 기억하고 활용하는 효율적인 방법을 사용하는 인지적 능력을 길러주고, 그 인지능력을 활용하여 사고하는 학습태도를 형성시켜주어 아동의 주의집중, 문제해결능력 향상, 학습에 대한 동기부여, 효율적인 시간관리를 하도록 돕는 치료과정입니다.

아동의 현행수준을 정확히 파악하여 개별 학습특성에 맞도록 프로그램을 개발하고, 그것을 아동에게 적용하여 취약한 학습준비도와 학업 성취도를 향상시키는 것을 목적으로 구성된 프로그램입니다.`,
      targets: [
        "취학 전 기초학습의 개념습득이 필요한 아동",
        "또래에 비해 인지발달이 늦는 아동",
        "새로운 과제의 수행속도가 느린 아동",
        "셈하기, 읽기, 쓰기, 변별 및 색인지 등의 능력이 또래에 비해 늦는 아동",
        "주의집중이 되지 않으며, 책상에 앉아 있는 게 힘든 아동",
        "자신의 적성과 진로가 불확실하여 학습동기가 부족한 아동",
        "유아기때부터 학습에 대한 부정적인 경험을 많이 한 아동",
