...
미술치료에서의 미술은 작품의 완성도보다는 과정에서 나타나는 표현에 중심을 둠으로써 내담자 스스로 자신의 내면을 읽어낼 수 있고, 구체적인 결과물이 자료로 남게 됨에 따라 치료의 과정 자체를 객관적으로 관찰할 수 있다는 장점이 있습니다.`,
  ...
  {
    title: "인지학습",
    summary: "인지학습 프로그램 설명이 들어올 자리입니다.",
    detail: null,
  },
  {
    title: "사회성 그룹치료",
    ...
    detail: {
      description: `사회성 그룹치료는 또래와의 상호작용 속에서 의사소통, 감정조절, 관계 형성 능력을 배우고 연습하는 전문적인 소그룹 치료 프로그램입니다.

단순한 놀이가 아닌, 실제 상황을 기반으로 사회적 기술을 자연스럽게 익히고 반복 경험을 통해 적용할 수 있도록 돕습니다.

사회성은 단순한 관계 기술을 넘어 아이의 전반적인 적응과 성장에 영향을 주는 중요한 능력입니다. 사회성이 부족할 경우 또래 관계의 어려움이나 학교생활 부적응으로 이어질 수 있으며, 반대로 안정된 사회성은 자신감과 긍정적인 관계 형성의 기반이 됩니다.

누리봄은 아이의 발달 수준을 고려하여 적절한 소그룹을 구성하고, 실제 상황 중심의 활동을 통해 아이들이 자연스럽게 경험하고 익힐 수 있도록 돕습니다. 또한 전문가의 관찰과 피드백, 부모 상담을 함께 진행하여 가정에서도 연계가 이루어질 수 있도록 합니다.

사회성은 경험을 통해 천천히 만들어집니다. 아이의 현재 상태가 궁금하시다면 상담을 통해 확인해보세요.`,
      targets: [
        "친구들과 어울리는 것이 어려운 아이",
        "의사표현이 부족하거나 대화가 서툰 아이",
        "눈치나 상황 이해가 부족한 아이",
        "감정 조절이 어렵고 갈등이 잦은 아이",
        "소극적이거나 충동적인 행동을 보이는 아이",
      ],
      goals: [
        "또래와의 자연스러운 상호작용 능력 향상",
        "의사소통과 자기 표현 능력 향상",
        "규칙 이해와 집단 적응력 향상",
        "감정 조절과 자기 조절 능력 발달",
      ],
