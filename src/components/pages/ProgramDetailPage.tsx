...
export default function ProgramDetailPage({ program }: { program: Program }) {
  return (
    ...
    >
      {/* 타이틀 배너 */}
      <div className="relative flex flex-col items-center justify-center h-44 md:h-72 md:pt-16">
        <div className="absolute inset-0 bg-black/45" />
        <div className="relative text-center">
          <h1 className="text-3xl md:text-4xl font-bold text-white tracking-wide">{program.title}</h1>
